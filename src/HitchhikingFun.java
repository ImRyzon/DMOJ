...
public class HitchhikingFun {
    ...
    public static void main(String[] args) throws Exception {
        int n = r.readInt(), m = r.readInt(), dis[] = new int[n+1], cnt[] = new int[n+1];
        ...
        dijkstra(1, adj, dis, cnt);
        if (dis[n] == Integer.MAX_VALUE) pr.println(-1);
        else pr.println(dis[n] + " " + (cnt[n] + 1));
        pr.close();
    }

    static void dijkstra (int start, List<Edge> adj[], int dis[], int cnt[]) {
