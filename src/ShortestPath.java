...
public class ShortestPath {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Edge> vertices = new ArrayList<>();
        ...
        dijkstra(1, adj, dis, vertices);
        System.out.println();
    }

    static void dijkstra (int start, List<Edge> adj[], int dis[], List<Edge> vertices) {
